...
def main():
    ...
    plt.imsave(os.path.join(main_path, 'results', 'test_image.png'), normalize(test_image + 0.5), dpi=95)
    ...
    plt.imsave(os.path.join(main_path, 'results', 'identity_image.png'), normalize(identity_image + 0.5), dpi=95)
